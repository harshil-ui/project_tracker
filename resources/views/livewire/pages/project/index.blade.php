<div>
    ...
    <div class="max-w-1/2 mx-auto p-6">
        ...
        <div x-data="{ open: @entangle('showModal') }" class="w-[30%]">
            <!-- Trigger -->
            <button @click="open = true" class="bg-blue-600 text-white px-4 py-2 rounded float-right mb-2.5">
                Add
            </button>
            ...
            <div x-show="open" x-cloak
                ...
                <div class="bg-white rounded-lg shadow-lg w-1/2 p-6 relative">
                    ...
                    <button @click="open = false"
                        class="absolute top-2 right-2 text-gray-600 hover:text-gray-900 text-xl font-bold" wire:click="resetInput">
                        &times;
                    </button>

                    <!-- Add margin-top to content so it doesn't overlap the close button -->
                    <div class="mt-6">
                        <form class="space-y-5" wire:submit.prevent="save">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" placeholder="Enter title" wire:model.blur="title"
                            ...
                            <div>
                                ...
                                <textarea id="description" rows="4" placeholder="Enter description" wire:model.blur="description"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg
                                   focus:outline-none focus:ring-2 focus:ring-blue-500
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition float-left">
                    ...
                    @foreach ($projects as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            {{-- <td class="px-6 py-4 text-right">
                                ...
                                <button class="text-red-500 hover:text-red-700" title="Delete" wire:click="delete({{ $item->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5-4h4m-4 0a1 1 0 00-1 1v0a1 1 0 001 1h4a1 1 0 001-1v0a1 1 0 00-1-1m-4 0h4" />
